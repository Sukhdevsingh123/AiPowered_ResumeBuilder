...
//         {
//           role: "system",
//           content: "You are an expert resume writer. Generate a professional resume based on the provided details. Return the response as structured text with clear section headings (e.g., Profile, Skills, Experience). Do not add skills beyond those provided.",
//         },
//         {
//           role: "user",
//           content: `
...
//         case "EXPERIENCE":
//           if (line.startsWith("-")) {
//             resumeData.experience.push({ title: inputData.experience, details: [line.replace("- ", "")] });
//           } else if (resumeData.experience.length > 0) {
//             resumeData.experience[resumeData.experience.length - 1].details.push(line);
//           }
//           break;
//         default:
//           break;
...
//     resumeData.experience.push({ title: inputData.experience, details: ["Details not provided by AI."] });
//   }

//   // Fallback for profile if empty
//   if (!resumeData.profile) {
//     resumeData.profile = `Experienced ${inputData.role} with a strong background in ${inputData.skills}.`;
//   }
